        ...
        <div className="max-w-2xl">
          ...
          <div className="inline-flex items-center gap-2 bg-green-600/20 backdrop-blur-sm border border-green-400/30 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-green-300 text-sm font-semibold tracking-wide">
              Pakistan&apos;s Trusted Solar Company
            </span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
            Power Your Home &amp;{" "}
            <span className="text-green-400">Business</span> with
            Reliable Solar Energy
          </h1>

          {/* Subtext */}
          <p className="text-lg sm:text-xl text-gray-200 leading-relaxed mb-10 max-w-xl">
            MaxGreen Energy delivers high-performance solar systems with
            professional installation, net metering support, and guaranteed
            long-term savings across Karachi &amp; Lahore.
          </p>
